...
const MovieDetails = () => (
  <Popup trigger={<button className="movie__details"> 
      More details
        <FontAwesomeIcon
    ...
    {close => (
      <div className="modal">
        ...
        <div class="siderbar">
        <img className="img1" src="https://ssl-gfx.filmweb.pl/po/05/42/790542/7881430.6.jpg" alt="plakat - Avengers: Koniec gry (2019)"  />
        </div>
